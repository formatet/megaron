...
A caravan is people and pack animals walking across the map. Others can see it on the road, but not what it carries — the cargo is a secret until someone takes it. **It can be intercepted and seized** — yours by others, theirs by you. A hostile unit on watch ([[stances|sentry]]) near the road will stop a caravan that passes. Only [[messengers]] are safe. When it happens, both sides are told where, and exactly what cargo changed hands; the seized goods go to the raider's capital.
